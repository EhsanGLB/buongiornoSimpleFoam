...
This is a solver for steady forced convection heat transfer of nanofluid using buongiorno model to considere nanoparticle distribution based on foam-extend-4.1.
